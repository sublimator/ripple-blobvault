var dbcommon = function(config, knex, logger) {
    var db = knex;
    var self = {knex: db};
    var log = logger.log;
    ...
    var read = function(params, cb) {
        ...
        .catch(function(obj) {
            ...
            // well it should be logged ;)
            log("The actual error: ", obj);
    ...
    var update = function(params,cb) {
        ...
        .catch(function(obj) {
            ...
            // TODO: is this json marshalled and returned to blob-vault client?
